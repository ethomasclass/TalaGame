...
const beats = [
  ...
  {bg:'street', stage:'Pa is out of vinegar and service starts in forty minutes. Tala has to pick a store.'},
  ...
  {bg:'street', stage: () => STATE.cook.vinegar === 'cane'
     ? 'Mang Boy asks about Lola before he asks what she needs. He writes the vinegar in a notebook under the family’s name and does not say when to pay. The radio behind the counter is playing a Christmas song in Tagalog, and on the way out he turns it up.'
