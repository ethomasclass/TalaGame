...
const VARIANTS = {
  main:  { choice:[1,1,2,2,3], cook:['A','A','A'], phone:[2,3,2,3] },   // invite, Mang Boy's, say nothing, sleep, wish: Bea stays
  getup: { choice:[2,2,1,1,1], cook:['B','C','A','B'], phone:[1,1,1,1] },   // working, chain, say something, get up, wish: Lola
};
(async()=>{
